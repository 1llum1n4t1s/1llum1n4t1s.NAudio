...
DirectSound playback and the winmm/ACM checks. Output should end with
`ACM stream header under NativeAOT: OK` and exit code 0. A `0xC0000005` access
violation, a fast-fail message, or
