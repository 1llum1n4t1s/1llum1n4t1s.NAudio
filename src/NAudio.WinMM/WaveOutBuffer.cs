...
internal class WaveOutBuffer : IDisposable
{
    ...
    public bool InQueue
    {
        get
        {
            // Keep the pointer check and dereference in the same critical section as Dispose.
            // CurrentLatency can inspect buffers from a thread that is not the playback thread.
            lock (waveOutLock)
            {
