...
VST 3® plug-in hosting for [NAudio](https://github.com/naudio/NAudio). Discover, load, and host VST 3 audio effects and instruments. Windows-only (`net10.0-windows`).
