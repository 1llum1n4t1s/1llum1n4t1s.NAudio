...
namespace NAudio.Wave
{
    ...
    public class WaveCallbackInfo
    {
        ...
        private WaveCallbackWindow _callbackWindow;
        private WaveCallbackWindowSubclass _subclass;
        ...
        internal void Connect(WaveInterop.WaveCallback callback)
        {
            ...
            {
                _callbackWindow = new WaveCallbackWindow(callback);
                Handle = _callbackWindow.Handle;
            }
            else if (Strategy == WaveCallbackStrategy.ExistingWindow)
            {
                _subclass = new WaveCallbackWindowSubclass(Handle, callback);
            }
        }
